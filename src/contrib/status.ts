//// Adapted from https://github.com/zegevlier/mcping (MIT license)
...
export const getStatus = async (ip: string) => {
    try {
        if (ip === null) {
		...
		/// {"version":{"name":"1.20.1","protocol":763},"enforcesSecureChat":true,"description":{"text":"A Minecraft Server"},"players":{"max":20,"online":0},"preventsChatReports":true}
		let json_obj: {
			version: {
				name: string,
				protocol: number
